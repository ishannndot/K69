...
const navigate = useNavigate();
    ...
    return (
        <div ref={fullScreenRef} id='fullscreennav' className='fullscreennav overflow-x-clip text-white  h-screen w-full z-50 absolute'>
            ...
            <div ref={fullNavLinksRef} className='relative'>
                <div className="navlink flex w-full justify-between lg:p-5 p-2 items-start">
                    ...
                    <div onClick={() => {
                        ...
                        <div className='lg:h-44 h-28 lg:w-1 w-0.5 -rotate-40 origin-top absolute bg-[#D3FD50]'></div>
                        <div className='lg:h-44 h-28 lg:w-1 w-0.5 right-0 rotate-45 origin-top absolute bg-[#D3FD50]'></div>

                    </div>
                </div>
                <div  className=' py-36'>
                    <div onClick={() => { setNavOpen(false); navigate("/"); }}className='link origin-top relative border-t border-white'>
                    ...
                    <div onClick={() => { setNavOpen(false); navigate("/agence"); }} className='link origin-top relative border-t border-white'>
                    ...
                    <div onClick={() => { setNavOpen(false); navigate("/projects"); }} className='link origin-top relative border-t border-white'>
                    ...
                    <div onClick={() => { setNavOpen(false); navigate("/contact"); }}className='link origin-top relative border-y border-white'>
